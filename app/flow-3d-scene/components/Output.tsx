...
export function Output({ data }) {
  return (
    <div className="h-80 w-70 rounded-md bg-zinc-800 overflow-hidden border border-solid border-green-500">
      ...
      <div className="p-2 bg-green-600 z-10  text-white">Output</div>
      <div>
        <Scene />
      </div>
    </div>
